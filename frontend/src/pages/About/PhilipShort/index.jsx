...
const BIO = [
  ...
  "After high school, Philip attended Mississippi Gulf Coast Community College, where he continued to excel as a quarterback. His outstanding performance earned him 1st-Team JUCO All-American honors, paving the way for him to sign with Jackson State University. At JSU, he completed his college career and earned a Bachelor's degree in Finance. Philip is currently furthering his education by pursuing a Masters of Business Administration (MBA) at Mississippi College, combining his passion for sports with a strong foundation in business and leadership.",
  "Today, Philip is focused on training and developing the next generation of quarterbacks, as well as speed enhancement with athletes from all sports. Based in the Jackson Metro area, he works with young athletes to enhance their skills, specializing in quarterback mechanics, decision-making, and leadership on and off the field. Philip's method combines traditional drills with advanced video analysis and sports psychology, tailoring training plans to fit each athlete's unique strengths and areas for growth. His expertise and dedication have made him a trusted coach for aspiring quarterbacks looking to reach their full potential.",
];

const VIDEOS = [
  { title: 'Philip Short Bio Video', vimeo_id: '1027326776', type: 'Bio' },
...
export default function PhilipShort() {
  return (
    <BioPage
      portrait={portrait}
      name="Philip Short"
